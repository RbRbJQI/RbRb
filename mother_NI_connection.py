...
from labscript_utils.unitconversions.Coil_driver_Gcm_added import Coil_driver_Gcm_added
...
DigitalOut(name='coil_ch0_enable', parent_device=ni_usb_6229, connection='port0/line0')
DigitalOut(name='coil_ch0_0', parent_device=ni_usb_6229, connection='port0/line1')
DigitalOut(name='coil_ch0_1', parent_device=ni_usb_6229, connection='port0/line2')
DigitalOut(name='coil_ch1_enable', parent_device=ni_usb_6229, connection='port0/line3')
DigitalOut(name='coil_ch1_0', parent_device=ni_usb_6229, connection='port0/line4')
DigitalOut(name='coil_ch1_1', parent_device=ni_usb_6229, connection='port0/line5')
DigitalOut(name='coil_ch2_enable', parent_device=ni_usb_6229, connection='port0/line6')
DigitalOut(name='coil_ch2_0', parent_device=ni_usb_6229, connection='port0/line7')
DigitalOut(name='coil_ch2_1', parent_device=ni_usb_6229, connection='port0/line8')
DigitalOut(name='coil_ch3_enable', parent_device=ni_usb_6229, connection='port0/line9')
DigitalOut(name='coil_ch3_0', parent_device=ni_usb_6229, connection='port0/line10')
DigitalOut(name='coil_ch3_1', parent_device=ni_usb_6229, connection='port0/line11')
...
AnalogOut(name='coil_ch0', parent_device=ni_usb_6229, connection='ao0', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-40, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-40} )
AnalogOut(name='coil_ch1', parent_device=ni_usb_6229, connection='ao1', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-12, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-12})
AnalogOut(name='coil_ch2', parent_device=ni_usb_6229, connection='ao2', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-40, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-40})
AnalogOut(name='coil_ch3', parent_device=ni_usb_6229, connection='ao3', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-40, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-40})
