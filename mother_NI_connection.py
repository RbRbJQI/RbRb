...
AnalogOut(name='coil_ch1', parent_device=ni_usb_6229, connection='ao0', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-40, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-40} )
AnalogOut(name='coil_ch2', parent_device=ni_usb_6229, connection='ao1', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-12, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-12})
AnalogOut(name='coil_ch3', parent_device=ni_usb_6229, connection='ao2', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-40, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-40})
AnalogOut(name='coil_ch4', parent_device=ni_usb_6229, connection='ao3', unit_conversion_class=Coil_driver_Gcm_added, unit_conversion_parameters={'A_per_V':-40, 'Gcm_per_A':2.4, 'A_offset':0, 'A_min':-40})
